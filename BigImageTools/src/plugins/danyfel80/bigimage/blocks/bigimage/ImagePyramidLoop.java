...
public class ImagePyramidLoop extends Loop {
	...
	public void initializeLoop() {
		...
		try {
			this.resultWriter = new BigImageWriter(resultFile.getValue(), imageDimension.getValue(), resultChannels.getValue(), resultDataType.getValue(),
			    currentScaleTileDimension);
